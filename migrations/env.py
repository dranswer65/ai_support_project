...
# Alembic Config object (this is what was missing!)
...
# ---- Load DATABASE_URL from env and set it for Alembic ----
db_url = os.getenv("DATABASE_URL")
if not db_url:
    raise RuntimeError(
        "DATABASE_URL is not set. In PowerShell: "
        '$env:DATABASE_URL="postgresql+psycopg://user:pass@host:port/db?sslmode=require"'
    )
