# admin_ui/onboarding_dashboard.py
...
# templates folder: admin_ui/templates
...
async def onboarding_page(request: Request):
    ...
    Protected by platform ADMIN_TOKEN, not tenant token.

    Open like:
      /admin/onboarding?token=YOUR_PLATFORM_ADMIN_TOKEN
    """
